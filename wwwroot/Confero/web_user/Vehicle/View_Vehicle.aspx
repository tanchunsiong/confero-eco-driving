<%@ Page Language="VB" AutoEventWireup="false" CodeFile="View_Vehicle.aspx.vb" Inherits="Vehicle_View_Vehicle" MasterPageFile="~/MasterPage2.master" %>
...
<br/>
    <table width="970" align="center">
        <tr>
            <td colspan="3"> 
                <asp:Label ID="lblTitle" runat="server" Text="View Vehicle" CssClass="title_label"></asp:Label><br/><br/>
            </td>
        </tr>
         <tr valign="top">
                        ...
                        <tr>
                            ...
                            <td style="height: 32px; width: 130px;">
                                <asp:DropDownList ID="lstSelect" runat="server" Width="130px">
                                    ...
                                    <asp:ListItem value="tblVehicle.Capacity">Capacity</asp:ListItem>
                                    <asp:ListItem value="tblVehicle.Make">Make</asp:ListItem>
                                    <asp:ListItem value="tblVehicle.Years">Years</asp:ListItem>
        ...
        <tr>
            <td colspan="3">
                <asp:DataGrid ID="grdData" runat="server" AutoGenerateColumns="False"
                   ...
                   GridLines="None" CssClass="dataGrid" Width="705px">
                    ...
                    <Columns>                     
                        <asp:BoundColumn DataField="VehicleID" Visible="False"></asp:BoundColumn>
                        ...
                        <asp:BoundColumn DataField="Years" HeaderText="Years"></asp:BoundColumn>            
                        ...
                        <asp:ButtonColumn ButtonType="PushButton" Text="Mileage" CommandName="mileage"></asp:ButtonColumn>
