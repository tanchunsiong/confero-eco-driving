<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Update_Vehicle.aspx.vb" Inherits="Vehicle_Update_Vehicle" MasterPageFile="~/MasterPage2.master" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
  <br/>
    ...
    <table width="970" align="center">
        <tr>
            <td colspan="3"> 
                <asp:Label ID="lblTitle" runat="server" Text="Update Vehicle" CssClass="title_label"></asp:Label><br/><br/>
            </td>
        </tr>
        <tr>
            <td colspan="3"> 
        ...
        <tr>
            <td style="width: 160px; height: 26px;"> &nbsp;<asp:RequiredFieldValidator ID="vadMake" runat="server" ErrorMessage="*" ControlToValidate="txtMake"></asp:RequiredFieldValidator>
        ...
        <tr>
            ...
            <td>
                <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server"
                    TargetControlID="txtYears"
                    FilterType="Numbers">
                </ajaxToolkit:FilteredTextBoxExtender>
            </td>
        </tr>
          <tr>
            <td style="width: 160px; height: 26px;"> &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" ControlToValidate="txtCapacity"></asp:RequiredFieldValidator>
            ...
            <td style="height: 26px"><ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server"
        ...
        <tr>
            ...
            <td align="right">
                &nbsp;&nbsp; &nbsp;<asp:Button ID="btnAdd" runat="server" Text="Update" /></td>    
            <td>
            </td>
        </tr>
