<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Change_Password.aspx.vb" Inherits="User_Change_Password" MasterPageFile="~/MasterPage2.master" %>
...
<br/>
    <table width="970" align="center">
        ...
        <tr>
            <td style="width: 178px;"> &nbsp;<asp:RequiredFieldValidator ID="vadPwd" runat="server" ControlToValidate="txtPassword"
                    ErrorMessage="*"></asp:RequiredFieldValidator>
                <asp:Label ID="lblPassword" runat="server" Text="Password:" CssClass="normal_label"></asp:Label></td>
            <td style="width: 82px;">
                <asp:TextBox ID="txtPassword" runat="server" TextMode="Password" Width="149px" MaxLength="45"></asp:TextBox>&nbsp;
