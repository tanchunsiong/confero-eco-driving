<%@ Page Language="VB" AutoEventWireup="false" CodeFile="View_Tyre.aspx.vb" Inherits="Tyre_View_Tyre" MasterPageFile="~/MasterPage.master" %>
    ...
    <table width="970" align="center">
        ...
        <tr valign="top">
            ...
            <td style="height: 110px; width: 15px;">
                        ...
                        <tr>
                            ...
                            <td style="height: 32px; width: 130px;">
                                <asp:DropDownList ID="lstSelect" runat="server" Width="130px">
                                    ...
                                    <asp:ListItem Value="type">Tyre Type</asp:ListItem>
                                    <asp:ListItem Value="tyreSize">Tyre Size</asp:ListItem>
                                    <asp:ListItem Value="width">Width</asp:ListItem>
                                    <asp:ListItem value="rollingresistance">Rolling Resistance</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                ...
                <br />
                <asp:Label ID="lblStatus" runat="server" ForeColor="Green" Width="507px"></asp:Label></td>
        ...
        <tr>
            <td colspan="5">
                   ...
                   GridLines="None" CssClass="dataGrid" Width="817px">
