<%@ Page Language="VB" AutoEventWireup="false" CodeFile="View_Propellent.aspx.vb" Inherits="Propellent_View_Propellent" MasterPageFile="~/MasterPage.master" %>
    ...
    <table width="970" align="center">
        ...
        <tr valign="top">
            ...
            <td style="height: 110px; width: 15px;">
                ...
                <br />
                <asp:Label ID="lblStatus" runat="server" ForeColor="Green" Width="510px"></asp:Label></td>
