<%@ Page Language="VB" AutoEventWireup="false" CodeFile="View_PropellentType.aspx.vb" Inherits="Propellent_View_PropellentType" MasterPageFile="~/MasterPage.master" %>
...
<br/>
    <table width="970" align="center">
        <tr>
            <td colspan="3"> 
                <asp:Label ID="lblTitle" runat="server" Text="View Propellent Type" CssClass="title_label"></asp:Label><br/><br/>
            </td>
        </tr>
         <tr valign="top">
            ...
            <td style="height: 110px; width: 15px;">
                ...
                <br />
                <asp:Label ID="lblStatus" runat="server" ForeColor="Green" Width="509px"></asp:Label></td>
        ...
        <tr>
            <td colspan="3">
               <asp:DataGrid ID="grdData" runat="server" AutoGenerateColumns="False"
                   ...
                   GridLines="None" CssClass="dataGrid" Width="390px">
