<%@ Page Language="VB" AutoEventWireup="false" CodeFile="View_Vehicle_Type.aspx.vb" Inherits="Vehicle_View_Vehicle_Type" MasterPageFile="~/MasterPage.master" %>
...
<br/>
    <table width="970" align="center">
        <tr>
            <td colspan="3"> 
                <asp:Label ID="lblTitle" runat="server" Text="View Vehicle Type" CssClass="title_label"></asp:Label><br/><br/>
            </td>
        </tr>
         <tr valign="top">
            ...
            <td style="height: 110px; width: 15px;">
                ...
                <br />
                <asp:Label ID="lblStatus" runat="server" ForeColor="Green" Width="502px"></asp:Label></td>
            ...
            <td colspan="3">
               <asp:DataGrid ID="grdData" runat="server" AutoGenerateColumns="False"
                   ...
                   GridLines="None" CssClass="dataGrid" Width="381px">
                    ...
                    <Columns>                     
                        <asp:BoundColumn DataField="VehicleTypeID" Visible="False"></asp:BoundColumn>
