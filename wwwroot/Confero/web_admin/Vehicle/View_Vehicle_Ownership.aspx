<%@ Page Language="VB" AutoEventWireup="false" CodeFile="View_Vehicle_Ownership.aspx.vb" Inherits="Vehicle_View_Vehicle_Ownership" MasterPageFile="~/MasterPage.master" %>
...
<br/>
    <table width="970" align="center">
        <tr>
            <td colspan="3"> 
                <asp:Label ID="lblTitle" runat="server" Text="View Vehicle Ownership" CssClass="title_label"></asp:Label><br/><br/>
            </td>
        </tr>
       <tr valign="top">
                        ...
                        <tr>
                            ...
                            <td style="height: 32px; width: 130px;">
                                <asp:DropDownList ID="lstSelect" runat="server" Width="130px">
                                    ...
                                    <asp:ListItem Value="tblVehicleOwnership.vehicleID">Vehicle ID</asp:ListItem>
                                </asp:DropDownList>
                            </td>
        ...
        <tr>
            <td colspan="3">
                <asp:DataGrid ID="grdData" runat="server" AutoGenerateColumns="False"
                   ...
                   GridLines="None" CssClass="dataGrid" Width="381px">
                    ...
                    <Columns>                     
                        <asp:BoundColumn DataField="OwnershipID" Visible="False"></asp:BoundColumn>
