<%@ Page Language="VB" AutoEventWireup="false" CodeFile="View_Vehicle_Configuration.aspx.vb" Inherits="Vehicle_View_Vehicle_Configuration" MasterPageFile="~/MasterPage.master" %>
...
<br/>
    <table width="970" align="center">
        <tr>
            <td colspan="3"> 
                <asp:Label ID="lblTitle" runat="server" Text="View Vehicle Configuration" CssClass="title_label"></asp:Label><br/><br/>
            </td>
        </tr>
         <tr valign="top">
            ...
            <td style="height: 110px; width: 15px;">
                        ...
                        <tr>
                            ...
                            <td style="height: 32px; width: 130px;">
                                <asp:DropDownList ID="lstSelect" runat="server" Width="130px">
                                    <asp:ListItem Value ="propellentID">Propellent ID</asp:ListItem>
                                    <asp:ListItem Value="tyreID">Tyre ID</asp:ListItem>
                                    <asp:ListItem Value="vehicleID">Vehicle ID</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                ...
                <br />
                <asp:Label ID="lblStatus" runat="server" ForeColor="Green" Width="503px"></asp:Label></td>
        ...
        <tr>
            <td colspan="3">
                <asp:DataGrid ID="grdData" runat="server" AutoGenerateColumns="False"
                   ...
                   GridLines="None" CssClass="dataGrid" Width="510px">
                    ...
                    <Columns>                     
                        ...
                        <asp:BoundColumn DataField="PropellentID" HeaderText="Propellent ID"></asp:BoundColumn>   
                        <asp:BoundColumn DataField="TyreID" HeaderText="Tyre ID"></asp:BoundColumn>   
                        <asp:BoundColumn DataField="VehicleID" HeaderText="Vehicle ID"></asp:BoundColumn>                       
