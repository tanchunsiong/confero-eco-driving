...
Partial Class Vehicle_View_Vehicle_Ownership
    ...
    Sub bindData()
        ...
        If Not txtSearch.Text.Trim.Equals("") Then
            objArrayList = objDBVehicle.Search_By_VehicleOwnership(lstSelect.SelectedValue, txtSearch.Text)
            lblSearch.Text = "Search Record: " + objArrayList.Count.ToString
        Else
            objArrayList = objDBVehicle.Get_All_VehicleOwnership
    ...
    Protected Sub grdData_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles grdData.ItemCommand
        ...
        If (e.CommandName.Equals("delete")) Then
            If IsNumeric(e.Item.Cells(0).Text) Then
                ...
                If reply = vbYes Then
                    Try
                        objVehicleConfiguration = objDBVehicle.Get_Single_VehicleConfiguration(e.Item.Cells(3).Text)
                        ...
                        objDBVehicle.Delete_By_VehicleOwnership(e.Item.Cells(0).Text, e.Item.Cells(3).Text)
                        bindData()
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        ...
        If txtSearch.Text.Trim.Equals("") Then
            query = "SELECT tblVehicleOwnership.*, tblUser.loginID " & _
        ...
        header = "List of vehicle ownership"
