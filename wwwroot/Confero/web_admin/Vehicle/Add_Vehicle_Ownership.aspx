<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Add_Vehicle_Ownership.aspx.vb" Inherits="Vehicle_Add_Vehicle_Ownership" MasterPageFile="~/MasterPage.master" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
   <br/>
    ...
    <table width="970" align="center">
        <tr>
            <td colspan="3"> 
                <asp:Label ID="lblTitle" runat="server" Text="Add Ownership" CssClass="title_label"></asp:Label><br/><br/>
            </td>
        </tr>
        <tr>
            <td colspan="3"> 
        ...
        <tr>
            <td style="width: 160px"> &nbsp;<asp:RequiredFieldValidator ID="vadUser" runat="server" ErrorMessage="*" ControlToValidate="lstUsername"></asp:RequiredFieldValidator>
                <asp:Label ID="lblUsername" runat="server" Text="User Name:" CssClass="normal_label"></asp:Label>    
            </td>
            <td style="width: 82px">
                <asp:DropDownList ID="lstUsername" runat="server" Width="156px">
                </asp:DropDownList>
            </td>
            <td>
                </td>
        ...
        <tr>
            <td style="width: 160px; height: 26px;"> &nbsp;<asp:RequiredFieldValidator ID="vadModel" runat="server" ErrorMessage="*" ControlToValidate="txtModel"></asp:RequiredFieldValidator>
                <asp:Label ID="lblModel" runat="server" Text="Model:" CssClass="normal_label"></asp:Label></td>
            <td style="width: 82px; height: 26px;">
                <asp:TextBox ID="txtModel" runat="server" MaxLength="45"></asp:TextBox>
            </td>
        ...
        <tr>
            ...
            <td style="width: 82px">
                <asp:TextBox ID="txtMake" runat="server" MaxLength="45"></asp:TextBox>
            </td>
        ...
        <tr>
            ...
            <td style="width: 82px">
                <asp:TextBox ID="txtYears" runat="server" MaxLength="45"></asp:TextBox>
            </td>
            
            <td>
                <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server"
                    FilterType="Numbers" TargetControlID="txtYears">
          ...
          <tr>
            ...
            <td style="width: 82px">
                <asp:TextBox ID="txtCapacity" runat="server" MaxLength="45"></asp:TextBox>
            </td>
            
            <td>
                <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server"
                    FilterType="Numbers" TargetControlID="txtCapacity">
                </ajaxToolkit:FilteredTextBoxExtender>
                </td>
        </tr>
        <tr>
