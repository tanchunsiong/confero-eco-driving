<%@ Page Language="VB" AutoEventWireup="false" CodeFile="View_User.aspx.vb" Inherits="User_View_User" MasterPageFile="~/MasterPage.master" %>
...
<br/>
    <table width="970" align="center">
        <tr>
            <td colspan="3"> 
                <asp:Label ID="lblTitle" runat="server" Text="View User Account" CssClass="title_label"></asp:Label><br/><br/>
            </td>
        </tr>
        <tr valign="top">
            ...
            <td style="height: 110px; width: 15px;">
                        ...
                        <tr>
                            ...
                            <td style="height: 32px; width: 130px;">
                                <asp:DropDownList ID="lstSelect" runat="server" Width="130px">
                                    <asp:ListItem Value="loginID">User Name</asp:ListItem>
                                    <asp:ListItem Value="type">Role</asp:ListItem>
                ...
                <br />
                <asp:Label ID="lblStatus" runat="server" ForeColor="Green" Width="504px"></asp:Label></td>
        ...
        <tr>
            <td colspan="5">
                  <asp:DataGrid ID="grdData" runat="server" AutoGenerateColumns="False"
                   ...
                   GridLines="None" CssClass="dataGrid" Width="900px" >
                    ...
                    <Columns>                     
                        ...
                        <asp:BoundColumn DataField="LoginId" HeaderText="User name"></asp:BoundColumn>   
                        <asp:BoundColumn DataField="Type" HeaderText="Role"></asp:BoundColumn>
