<%@ Page Language="VB" AutoEventWireup="false" CodeFile="View_User_Generated.aspx.vb" Inherits="User_View_User_Generated" MasterPageFile="~/MasterPage.master" %>
    ...
    <table width="970" align="center">
        ...
        <tr valign="top">
            ...
            <td style="height: 110px; width: 15px;">
                ...
                <br />
                <asp:Label ID="lblStatus" runat="server" ForeColor="Green" Width="506px"></asp:Label></td>
        ...
        <tr>
            <td colspan="3">
                  <asp:DataGrid ID="grdData" runat="server" AutoGenerateColumns="False"
                   ...
                   GridLines="None" CssClass="dataGrid" Width="866px">
