<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Update_User.aspx.vb" Inherits="User_Update_User" MasterPageFile="~/MasterPage.master" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
 ...
 <br/>
    <table width="970" align="center">
        <tr>
            <td colspan="3"> 
                <asp:Label ID="lblTitle" runat="server" Text="Update User Account" CssClass="title_label"></asp:Label><br/><br/>
            </td>
        </tr>
        <tr>
            <td colspan="3"> 
        ...
        <tr>
            ...
            <td style="width: 179px; height: 30px;"><asp:DropDownList ID="lstRole" runat="server" Width="99px">
        ...
        <tr>
            <td style="width: 178px;" valign="top"> &nbsp;<asp:RequiredFieldValidator ID="vadPwd" runat="server" ControlToValidate="txtUsername"
                    ErrorMessage="*"></asp:RequiredFieldValidator>
            ...
            <td valign="top">
                <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server"
                    ControlToValidate="txtPassword" ErrorMessage="Password must have a minimum length of 8 characters."
                    ValidationExpression="^.{8,40}$"></asp:RegularExpressionValidator></td>
        </tr>
        <tr>
            <td style="width: 178px; height: 30px;"> &nbsp;<asp:RequiredFieldValidator ID="vadCPwd" runat="server" ControlToValidate="txtUsername"
